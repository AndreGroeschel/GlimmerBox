...
abstract class $TraitCopyWith<$Res> {
  ...
  @useResult
  $Res call({String value, String traitType});
}
...
class _$TraitImpl implements _Trait {
  const _$TraitImpl({this.value = '', this.traitType = ''});
  ...
  @override
  String toString() {
    return 'Trait(value: $value, traitType: $traitType)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, value, traitType);
...
abstract class _Trait implements Trait {
  const factory _Trait({final String value, final String traitType}) =
      _$TraitImpl;
